...
public class Doctor {
	...
	public static void main(String[] args) throws InterruptedException, AWTException {
		...
		String file = "\"C:\\Users\\RajalakshmiRajasekar\\Downloads\\image.jpg\"";
	  ...
	  // Thread.sleep(2000);
	   ...
	   Thread.sleep(2000);
	   WebElement medication=driver.findElement(By.xpath("//div[@class='mb-2']/span//u[text()='Medication']"));
	   summaryJS.executeScript("arguments[0].scrollIntoView()", medication);
	   Thread.sleep(2000);
	   ...
	   Thread.sleep(2000);
//	   driver.findElement(By.cssSelector("cr-button[class='cancel-button']")).click();
//	   Thread.sleep(2000);
